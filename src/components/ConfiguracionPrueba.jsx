...
function ConfiguracionPrueba({ cantidad, setCantidad, dificultad, setDificultad, alIniciar }) {
  ...
  const niveles = [
    { id: 1, label: 'Base', desc: 'Calentamiento', icon: <Rocket size={24} />, color: 'from-blue-400 to-blue-600' },
    { id: 2, label: 'Medio', desc: 'Examen Real', icon: <Target size={24} />, color: 'from-emerald-400 to-emerald-600' },
  ...
  return (
    <div className="min-h-screen w-full bg-[#fdfbf7] flex items-center justify-center p-4 md:p-10 relative overflow-hidden">
      ...
      <div className="ficha-viktoria w-full max-w-2xl animate-viktoria border-none p-0 overflow-hidden bg-white shadow-[0_40px_80px_-15px_rgba(0,0,0,0.1)]">
        ...
        <header className="bg-[#0f172a] p-10 md:p-14 text-center relative">
          ...
          <h1 className="text-5xl font-black italic tracking-tighter text-white">
            Viktoria <span className="text-emerald-400 underline decoration-wavy decoration-1 underline-offset-8">UNAM</span>
          </h1>
